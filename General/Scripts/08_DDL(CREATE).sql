...
-- 체크 제약조건(KH_KSM.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	...
	CONSTRAINT UK_USER_ID   UNIQUE      (USER_ID), -- 중복안함
	CONSTRAINT UK_PNO       UNIQUE      (PNO),  		-- 중복안함
	CONSTRAINT CK_GENDER    CHECK   (GENDER IN ('남','여')),  		-- 중복안함
	CONSTRAINT CK_STATUS    CHECK   (STATUS IN ('Y','N'))   		-- 중복안함
);
----------------------- 컬럼 주석
